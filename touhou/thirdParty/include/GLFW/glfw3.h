 ...
 *  @ingroup input
 */
typedef void (* GLFWkeyfun)(GLFWwindow* window, int keyEvent, int scancode, int action, int mods);
 ...
 *  @ingroup input
 */
GLFWAPI const char* glfwGetKeyName(int keyEvent, int scancode);
 ...
 *  @ingroup input
 */
GLFWAPI int glfwGetKeyScancode(int keyEvent);
 ...
 *  @ingroup input
 */
GLFWAPI int glfwGetKey(GLFWwindow* window, int keyEvent);
